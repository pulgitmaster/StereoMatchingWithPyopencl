...
class SAD():
    ...
    def get_depth(self, left_img, right_img, kernel_size=5, dispRange=64, sad_thread_num=(16, 16, 4), wta_thread_num=(16, 16), host_mem=False):       # arguments
        # arguments
        h = left_img.shape[0]
        w = left_img.shape[1]
        var_width = np.int32(w)
