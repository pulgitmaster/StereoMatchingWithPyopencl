...
#https://www.researchgate.net/profile/Uwe_Hanebeck/publication/228940930_Template_matching_using_fast_normalized_cross_correlation/links/0912f505b4c9272358000000.pdf
class NCC():
    def __init__(self, kernel_source_path=None, VERBOSE=True):
        ...
        src_path = os.path.join(os.getcwd(), 'NCC.cl')
    ...
    def get_costvolume(self, left_img, right_img, kernel_size=5, dispRange=64, ncc_thread_num=(16, 16, 4), host_mem=False):
